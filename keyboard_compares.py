...
#r = 0.998
#rs = [8.19, 3.87, 2.196, 0.992][::-1]
#vs = []
#for bits in range(1<<len(rs)):
#	print " ".join(str(int(bool(bits&(1<<n)))) for n in range(len(rs))[::-1]),
#	if bits != 0:
#		r_total = (1.0/sum((1.0/r) * int(bool((bits&(1<<n)))) for (n,r) in enumerate(rs))) 
#		vs.append(r/(r + r_total))
#		print r_total
#	else:
#		vs.append(0.0)
#		print "inf"
...
#vs = sorted(vs)
#import operator
#diffs = sorted(map(operator.sub, vs[1:] + [1.0], vs))
#
#print
